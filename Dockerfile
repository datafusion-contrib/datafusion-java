...
COPY --from=java-builder /usr/opt/datafusion_java/datafusion_examples/build/libs/datafusion_examples-0.3-all.jar ./

CMD ["--class-path", "/usr/opt/datafusion_java/datafusion_examples-0.3-all.jar", "-R", "-Djava.library.path=/usr/opt/datafusion_java"]
