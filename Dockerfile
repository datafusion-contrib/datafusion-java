...
COPY --from=java-builder /usr/opt/datafusion_java/datafusion_examples/build/libs/datafusion_examples-0.3-SNAPSHOT-all.jar ./

CMD ["--class-path", "/usr/opt/datafusion_java/datafusion_examples-0.3-SNAPSHOT-all.jar", "-R", "-Djava.library.path=/usr/opt/datafusion_java"]
