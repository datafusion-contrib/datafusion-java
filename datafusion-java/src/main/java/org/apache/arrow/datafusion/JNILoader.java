...
final class JNILoader {
    ...
    private static final String ERROR_MSG = String.format("Unsupported OS/arch, cannot find %s or load %s from system libraries. Please try building from source the jar or providing %s in your system.", getResourceName(), libraryName, libraryName);
    ...
    private static final Map<OsName, String> OS_NAME_STRING_MAP = Map.of(OsName.Linux, "so", OsName.Osx, "dylib", OsName.Windows, "dll");
